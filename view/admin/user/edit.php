                            ...
                            <div class="box box-primary">
                                ...
                                <div class="box-body">
                                    <div class="form-group">
                                        ...
                                        <div>
                                            <input type="email" name="email" value="<?= $userdbd['email'] ?>"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div>
                                            <input type="text" name="username" value="<?= $userdbd['username'] ?>"
                                                class="form-control form-autocomplete-stop">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div>
                                            <input type="text" name="avatar" value="<?= $userdbd['avatar'] ?>"
                                                class="form-control form-autocomplete-stop">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div>
                                            <select name="root_admin" class="form-control">
                                                <?php if ($userdbd['admin'] == "false") {
                                                    ?>
                                                    <option value="0" selected="&quot;selected&quot;">No</option>
                                                    <option value="1">Yes</option>
                                                    <?php
                                                } else if ($userdbd['admin'] == "true") {
                                                    ?>
